		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Process",
									"targetURL": "#comerossalesprocess-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerossalesprocess-display": {
								"semanticObject": "comerossalesprocess",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.salesprocess",
									"url": sap.ui.require.toUrl("com/eros/salesprocess")
								}
							}
						}
					}
